...
vnoremap <silent> <Plug>MoveBlockCountLinesDown :<C-u> silent call <SID>MoveBlockVertically( v:count1)<CR>:call repeat#set("\<Plug>MoveBlockDown")<CR>gv
vnoremap <silent> <Plug>MoveBlockCountLinesUp   :<C-u> silent call <SID>MoveBlockVertically(-v:count1)<CR>:call repeat#set("\<Plug>MoveBlockUp")<CR>gv
"
...
vnoremap <silent> <expr> <Plug>MoveBlockRelativeLinesDown ':<C-u> silent call <SID>MoveBlockVertically(<SID>RelativeLinesDistance( 1, line("''>") - ' .. line('.') .. '))<CR>:call repeat#set("\<Plug>MoveBlockRelativeLinesDown")<CR>gv'
vnoremap <silent> <expr> <Plug>MoveBlockRelativeLinesUp   ':<C-u> silent call <SID>MoveBlockVertically(<SID>RelativeLinesDistance(-1, ' .. line('.') .. ' - line("''<")))<CR>:call repeat#set("\<Plug>MoveBlockRelativeLinesUp")<CR>gv'
...
nnoremap <silent> <Plug>MoveLineHalfPageDown    :<C-u> silent call <SID>MoveLineVertically( v:count1 * <SID>HalfPageSize())<CR>:call repeat#set("\<Plug>MoveLineHalfPageDown")<CR>
nnoremap <silent> <Plug>MoveLineHalfPageUp      :<C-u> silent call <SID>MoveLineVertically(-v:count1 * <SID>HalfPageSize())<CR>:call repeat#set("\<Plug>MoveLineHalfPageUp")<CR>
nnoremap <silent> <Plug>MoveCharRight           :<C-u> silent call <SID>MoveCharHorizontally( v:count1)<CR>:call repeat#set("\<Plug>MoveCharRight")<CR>
nnoremap <silent> <Plug>MoveCharLeft            :<C-u> silent call <SID>MoveCharHorizontally(-v:count1)<CR>:call repeat#set("\<Plug>MoveCharLeft")<CR>
